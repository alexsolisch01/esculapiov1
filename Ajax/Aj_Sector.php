...
if (isset($_POST['Requerimiento'])) {
	...
	if ($_POST['Requerimiento'] == "Guardar") {
		...
		$dao = new Dao();
		$dao->GuardarAjax("sectores", $datos);
	}
	if ($_POST['Requerimiento'] == "Modificar") {
		...
		$dao = new Dao();
		$dao->ModificarAjax("sectores", $datos, "id=" . $_POST['Id'], $_POST['Id']);
	}

	if ($_POST['Requerimiento'] == "Eliminar") {
		$dao = new Dao();
		$dao->EliminarAjax("sectores", $_POST['Id']);
	}
	if($_POST['Requerimiento'] == "CargarTablaSectorJS"){
		...
		$dao->TablasInnerAlias("sectores","p","canton","c");	
