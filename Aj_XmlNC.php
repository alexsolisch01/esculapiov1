...
$xmlFirmar = "//CONTABLE-PC//htdocs//Esculapio//facturas//".$claveAcceso.".xml";
$certificado = "//CONTABLE-PC//htdocs//Esculapio//facturas//0992894512001.p12";
$clave="FUNSISAmp3108";
$rutaFirmados="//CONTABLE-PC//htdocs//Esculapio//Firmados//";
$nombreXml=$claveAcceso.".xml";

$parametros = $certificado." ".$clave." ".$xmlFirmar." ".$rutaFirmados." ".$nombreXml;


$respuestajava = shell_exec('java -jar "//CONTABLE-PC//htdocs//Esculapio//java//FirmaXades.jar" '.$parametros);
