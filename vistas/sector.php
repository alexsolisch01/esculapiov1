<div class="col-md-12">
    <div class="box box-primary">
        ...
        <div class="box-body ">
            ...
            <div class="col-md-12">
                <br><br>
                <table id="datatableSector" width="100%" cellspacing="0" class="table nowrap table-condensed">
                    <thead>
                        <tr>
                            <th></th>
                            <th>CANTON</th>
                    ...
                    <div class="col-md-12">
                        <form role="form" method="post" id="FrmRegistro">
                            <div class="form-group col-md-12">
                                ...
                                <select id="cbmParroquia" class="selectpicker show-tick form-control input-sm" data-live-search="true">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" required class="form-control input-sm" autocomplete="off" id="nombreSector">
                            </div>
                            <div class="col-md-12">
...
<script src="js/Js_Sector.js?v=1.0"></script>