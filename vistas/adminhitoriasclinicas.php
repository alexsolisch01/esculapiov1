...
<input type="hidden" name="reporteEmelecCertificado" id="reporteEmelecCertificado" value="">
...
<div class="col-md-12">
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <button data-toggle="modal" title="CERTIFICADO" data-target="#modal-certificado" id="Certificado" class="btn btn-default"><img src="imagenes/certificado.png" /></button>
      ...
      <button id="EliminarAtencion" title="ELIMINAR ATENCION" class="btn btn-default pull-right"><img src="imagenes/delete.png" /></button>

      <button id="ImprimirTodoEmelec" title="IMPRIMIR" class="btn btn-default pull-right"><img src="imagenes/printer.png" /></button>
                      ...
                      <div class="row">
                        <div id="ListaEnfe2" class="box-body" style="max-height: 25em; overflow-y: auto;">
                          <ul class="todo-list" id="ListaAPF">
                            ...
                            <li><input type="checkbox" id="Hipertencion" value="Hipertencion"><span class="text">Hipertencion </span></li>
...
<div class="modal fade" id="modal-historico2" tabindex='1' data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="x_panel">
              ...
              <div class="x_content" style="height: 350px;max-height: 350px;overflow-y: auto;overflow-x: auto;">
                <table id="datatableFactura" cellspacing="0" class="table  table-condensed">
                  ...
                  <tbody style="padding: 0;font-size: 12px;">
...
<script src="js/Js_AdminHClinicas.js?v=1.15"></script>