  ...
  <div class="box box-default box-solid" style="height: 200px;">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right col-md-10">
        ...
        <div id="cargaProforma" class="pull-right">
    ...
    <div class="box-body">
      <div class="row invoice-info">
        ...
        <div class="col-md-5 invoice-col">
          ...
          <span id="notasCredito">NC : 001-000-000000000 </span><br>

          <button id="BuscarFact" data-toggle="modal" data-target="#modal-consulta-factura" type="button" style="margin-top: -11em;" class="btn btn-xs btn-default pull-right col-md-4" data-backdrop="static"> <i class="fa fa-search" aria-hidden="true"></i> BUSCAR FACTURA(F9)</button>

          <button id="BuscarOrden" data-toggle="modal" data-target="#modal-consulta-orden" type="button" style="margin-top: -8.50em;" class="btn btn-xs btn-default pull-right col-md-4" data-backdrop="static"> <i class="fa fa-search" aria-hidden="true"></i> BUSCAR ORDEN(F11)</button>

          <button id="AnularConsulta" type="button" disabled="true" style="margin-top: -6em;" class="btn btn-xs btn-danger pull-right col-md-4" data-backdrop="static"> <i class="fa fa-trash-o" aria-hidden="true"></i> ANULAR FACTURA</button>

          <button disabled type="button" style="margin-top: -3.91em;" class="btn btn-xs btn-success pull-right col-md-4" id="CobrarConsulta" data-backdrop="static"> <i class="fa fa-usd" aria-hidden="true"></i> COBRAR (F10)</button>

          <button type="button" style="margin-top: -3.91em; display: none;" class="btn btn-xs btn-success pull-right col-md-4" id="ReimprimirConsulta" data-backdrop="static"> <i class="fa fa-print" aria-hidden="true"></i> IMPRIMIR</button>

          <button type="button" style="margin-top: -1.5em;display: none;" class="btn btn-xs btn-primary pull-right col-md-4" id="ModificarFact" data-backdrop="static"> <i class="fa fa-usd" aria-hidden="true"></i> MODIFICAR</button>
        ...
        <div class="box box-body box-default">
          ...
          <div class="col-md-12 formaPago">
            ...
            <div class="col-md-12 fptarjeta">
              <label class="form-control">TOTAL EN TARJETA <i class="fa fa-plus pointer tarjeta" aria-hidden="true"></i>
              ...
              <div id="ctarjeta" style="display: none;">
                ...
                <div class="form-group col-md-4 noPinPad" style="display: none;">
                ...
                <div class="form-group col-md-4 noPinPad">
                  ...
                  <input type="text" required class="form-control input-sm" autocomplete="off" id="NumeroTarjeta">
                </div>
                <div class="form-group col-md-4 noPinPad">
...
<div class="col-md-12" style="margin-top: -1em;">
  <div class="box box-default box-solid">
    <div class="box-header with-border">
      <h3 class="box-title">FACTURACION DE CONSULTA Y SERVICIOS MÉDICOS</h3>
    ...
    <div class="box-body">
      ...
      <div class="col-md-12" style="margin-bottom:1em;">
        ...
        <div class="col-md-2">
          <button id="reservacionesFactura" type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-reservaciones" id="modalTac"> <img src="imagenes/october.png" /> RESERVACIONES</button>
        </div>
...
<div class="modal  fade" id="modal-consulta-factura" tabindex='15' data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="box-body">
          <div class="col-md-12">
            <div class="form-group col-md-4">
              <input type="text" class="form-control input-sm input-custom" autocomplete="off" id="numeroPF" placeholder="1">
            </div>
            <div class="form-group col-md-4">
...
<script src="js/Js_Facturacion.js?v=4.13"></script>
...
<script src="js/Js_Reservaciones.js?v=0.7"></script>
<script src="js/Js_CargarFacturaConsulta.js?v=2.1"></script>
<script src="js/Js_FormaCobro.js?v=1.2"></script>