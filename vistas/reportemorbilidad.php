<div class="col-md-12">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">        
        <li class="active"><a href="#tab_1" data-toggle="tab">REPORTE DE MORBILIDAD</a></li>
        <li><a href="#tab_2" data-toggle="tab">CAUSAS DE MORBILIDAD</a></li>
      </ul>
              ...
              <div class="col-md-12">
                    ...
                    <div class="form-group col-md-2">
                          <label for="Nombre">FRECUENCIA</label>
                            <select id="cbmFrecuencia2" class="selectpicker show-tick form-control input-sm" data-live-search="true">
                              <option value="5">5 MAS FRECUENTES</option>
                              <option value="10">10 MAS FRECUENTES</option>
                              <option value="15">15 MAS FRECUENTES</option>
                              <option value="1000">1000 MAS FRECUENTES</option>
                            </select>
                    </div>
                    ...
                    <div class="col-md-2 form-group ">
                        ...
                        <select id="cbmGrupoEdad2" class="selectpicker show-tick form-control" data-live-search="true">
                              <option value="0" min="-1" max="-1">Todas</option>
                              <option value="1" min="0" max="11">Menos de 1 año</option>                              
                              <option value="3" min="12" max="48">1 a 4 años</option>
                        </select>                                                  
                    </div>
...
<script src="js/Js_ReporteMorbilidad.js?v=1.14"></script>