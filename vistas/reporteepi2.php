<div class="col-md-12">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">        
        <li class="active"><a href="#tab_1" data-toggle="tab">REPORTE EPI</a></li>
          ...
          <div class="row">
              <div class="col-md-12">
                    ...
                    <div class="form-group col-md-2">
                          ...
                          <select id="cbmCie" class="selectpicker show-tick form-control input-sm"  multiple data-live-search="true">
...
<script src="js/Js_ReporteEpi2.js?v=0.1"></script>