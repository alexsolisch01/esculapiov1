<div class="col-md-12">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_1" data-toggle="tab">RECEPCIÓN</a></li>
    ...
    <div class="tab-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group col-md-3">
              ...
              <input class="form-control input-sm" type="date" id="fecha_consultaDesdeEco" value="<?php echo date("Y-m-d"); ?>">
            </div>
            <div class="form-group col-md-3">
              <label for="Nombre">FECHA HASTA </label>
              <input class="form-control input-sm" type="date" id="fecha_consultaHastaEco" value="<?php echo date("Y-m-d"); ?>">
            </div>

            <div class="form-group col-md-1">
              <label for="Nombre" style="color: white;">------</label>
              <button type="submit" id="ConsultarReccioncionEco" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i> CONSULTAR (F1)</button>
            </div>

            <div class="x_content">
              <table id="datatablePacienteEco" width="100%" class="table nowrap table-striped table-bordered table-condensed">
                <thead>
                  <tr>
                    <th>ATENCION</th>
                    <th>PACIENTE</th>
      ...
      <div class="tab-pane" id="tab_2">
        <div class="row">
          <div class="col-md-12">
            <button type="submit" id="GuardarResultadoEco" disabled="true" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> GUARDAR (F10)</button>
            <button type="submit" id="ValidarResultadoEco" disabled="true" class="btn btn-success"><i class="fa fa-floppy-o" aria-hidden="true"></i> VALIDAR (F9)</button>
            <button type="button" disabled="true" class="btn btn-dark" id="imprimirDatosEco"> <i class="fa fa-print" aria-hidden="true"></i> IMPRIMIR (F12)</button>
          ...
          <div class="col-md-12">
            ...
            <div class="form-group col-md-4">
              <div id="DatosPaciente" class="form-group col-md-12">
                ...
                <label id="CedulaPacienteResultado" hcu="normal" name="CÉDULA"></label><br>
              ...
              <div class="form-group col-md-12">
                <table id="datatableProcedimientoPacienteEco" class="table table-striped table-bordered table-condensed">
                  <thead>
                    <tr>
                      <th>PROCEDIMIENTO</th>
                      <th>
            ...
            <div class="form-group col-md-8">
              <div class="box-body pad">
                <form id="AlergiasForm">
                  <textarea id="plantillaecoWord" class="textarea" placeholder="Ingrese el texto aqui" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </form>
              </div>
            </div>
          </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="form-group col-md-3">
          <label for="Nombre">FECHA DESDE </label>
          <input class="form-control input-sm" type="date" id="fecha_consultaDesdeEcoInforme" value="<?php echo date("Y-m-d"); ?>">
        </div>
        <div class="form-group col-md-3">
          <label for="Nombre">FECHA HASTA</label>
          <input class="form-control input-sm" type="date" id="fecha_consultaHastaEcoInforme" value="<?php echo date("Y-m-d"); ?>">
        </div>

        <div class="form-group col-md-1">
          <label for="Nombre" style="color: white;">----</label>
          <button type="submit" id="ConsultarPacientesReceptadosEco" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i> CONSULTAR (F1)</button>
        </div>

      </div>

      <div class="modal-body">
        <table id="datatablePacientesListoEco" width="100%" class="table nowrap table-striped table-bordered table-condensed">
          <thead>
            <tr>
              <th>ID</th>
              <th>CÉDULA</th>
...
<div class="modal fade" id="modal-plantillas" tabindex="-1">
    ...
    <div class="modal-content" style="width: 50%; margin-left: 26%;">
      <div class="modal-header">
        ...
        <div class="form-group col-md-12">
          ...
          <label id="NombreEco">----</label>
        </div>
      </div>
      <div class="modal-body">
        <table id="datatablePlantillasEco" class="table table-striped table-bordered table-condensed">
          <thead>
            <tr>
              <th>PLANTILLA</th>
              <th>ID</th>
...
<script src="js/Js_RecepcionEco.js?v=1.6"></script>