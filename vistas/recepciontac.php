<div class="col-md-12">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_1" data-toggle="tab">TAC/RMN</a></li>
    ...
    <div class="tab-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group col-md-3">
              ...
              <input class="form-control input-sm" type="date" id="fecha_consultaDesdeTac" value="<?php echo date("Y-m-d"); ?>">
            </div>
            <div class="form-group col-md-3">
              <label for="Nombre">FECHA HASTA </label>
              <input class="form-control input-sm" type="date" id="fecha_consultaHastaTac" value="<?php echo date("Y-m-d"); ?>">
            </div>

            <div class="form-group col-md-1">
              <label for="Nombre" style="color: white;">------</label>
              <button type="submit" id="ConsultarReccioncionTac" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i> CONSULTAR (F1)</button>
            </div>

            <div class="x_content">
              <table id="datatablePacienteTac" width="100%" class="table nowrap table-striped table-bordered table-condensed">
                <thead>
                  <tr>
                    <th>ATENCION</th>
                    <th>PACIENTE</th>
      ...
      <div class="tab-pane" id="tab_2">
        <div class="row">
          <div class="col-md-12">
            <button type="submit" id="GuardarResultadoTac" disabled="true" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> GUARDAR (F10)</button>
            <button type="submit" id="ValidarResultadoTac" disabled="true" class="btn btn-success"><i class="fa fa-floppy-o" aria-hidden="true"></i> VALIDAR (F9)</button>
            <button type="button" onclick="printTextArea()" disabled="true" class="btn btn-dark" id="imprimirDatosTac"> <i class="fa fa-print" aria-hidden="true"></i> IMPRIMIR (F12)</button>
          ...
          <div class="col-md-12">
            ...
            <div class="form-group col-md-4">
              <div id="DatosPaciente" class="form-group col-md-12">
                ...
                <label id="CÉDULAPacienteResultado" name="CÉDULA"></label><br>
              ...
              <div class="form-group col-md-12">
                <table id="datatableProcedimientoPacienteTac" class="table table-striped table-bordered table-condensed">
                  <thead>
                    <tr>
                      <th>PROCEDIMIENTO</th>
                      <th>
            ...
            <div class="form-group col-md-8">
              <div class="box-body pad">
                <form id="AlergiasForm">
                  <textarea id="plantillaTacWord" class="textarea" placeholder="Ingrese el texto aqui" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </form>
              </div>
            </div>
          </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="form-group col-md-3">
          <label for="Nombre">FECHA DESDE </label>
          <input class="form-control input-sm" type="date" id="fecha_consultaDesdeTacInforme" value="<?php echo date("Y-m-d"); ?>">
        </div>
        <div class="form-group col-md-3">
          <label for="Nombre">FECHA HASTA</label>
          <input class="form-control input-sm" type="date" id="fecha_consultaHastaTacInforme" value="<?php echo date("Y-m-d"); ?>">
        </div>

        <div class="form-group col-md-1">
          <label for="Nombre" style="color: white;">----</label>
          <button type="submit" id="ConsultarPacientesReceptadosTac" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i> CONSULTAR (F1)</button>
        </div>

      </div>

      <div class="modal-body">
        <table id="datatablePacientesListoTac" width="100%" class="table nowrap table-striped table-bordered table-condensed">
          <thead>
            <tr>
              <th>ID</th>
              <th>CÉDULA</th>
    ...
    <div class="modal-content" style="width: 50%; margin-left: 26%;">
      <div class="modal-header">
        ...
        <div class="form-group col-md-12">
          ...
          <label id="NombreTac">----</label>
        </div>
      </div>
      <div class="modal-body">
        <table id="datatablePlantillasTac" class="table table-striped table-bordered">
          <thead>
            <tr>
              <th>PLANTILLA</th>
              <th>ID</th>
...
<script src="js/Js_RecepcionTac.js?v=1.3"></script>