...
$(".body").on('keyup', "input#ValorRecibidoConsulta", function(evt) {
    CalcularCobro($(this).val(), $('#ValorCheque').val(), $("#ValorTarjeta").val(),$('#totalAnticipo').text().replace('$',''));
    if (evt.keyCode == 13) {
...
function GuardarPagos(idConsulta, valorRecibido, valorRecibidoCheque, valorRecibidoTarjeta, valorCredito, valorRecibidoAnticipo) {
    if (valorRecibido > 0) {
